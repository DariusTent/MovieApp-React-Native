...
// Movie Details and Trailer Endpoints
...
const movieTrailerEndpoint = (id) =>
  `${apiBaseUrl}/movie/${id}/videos?api_key=${movieapikey}`;
...
export const fetchMovieTrailer = (id) => {
  return movieApiCall(movieTrailerEndpoint(id));
};
